...
# Görev
# Elimizdeki veri seti üzerinden minimum hata ile ev fiyatlarını tahmin eden bir makine öğrenmesi modeli
...
train = pd.read_csv("VBO/Alıştırmalar/7.Haftal ML - Adv.Tree decsion/house-prices-advanced-regression-techniques/train.csv")
test = pd.read_csv("VBO/Alıştırmalar/7.Haftal ML - Adv.Tree decsion/house-prices-advanced-regression-techniques/test.csv")
